...
or a new one is created.  If you need to do >From escaping, use the next option with a
program that does it (eg. L<formail(1)>).
Sometimes you can configure the MTA to do From escaping before it
